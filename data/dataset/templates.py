...
TEMPLATES: dict[str, tuple[QueryTemplate, ...]] = {
    ...
    "GENERAL_QUERY": (
        ...
        QueryTemplate("GENERAL_QUERY", "What does {METRIC} mean in a CVE record?"),
        QueryTemplate("GENERAL_QUERY", "How should analysts read {METRIC} for vulnerabilities?"),
        QueryTemplate("GENERAL_QUERY", "What does {SEVERITY} severity usually indicate?"),
        QueryTemplate("GENERAL_QUERY", "How is {SEVERITY} severity used in vulnerability triage?"),
        QueryTemplate("GENERAL_QUERY", "What does an affected product mean in CVE analysis?"),
        QueryTemplate("GENERAL_QUERY", "Why do CVE records mention products such as {PRODUCT}?"),
        QueryTemplate("GENERAL_QUERY", "How should I understand product names like {PRODUCT} in NVD data?"),
        QueryTemplate("GENERAL_QUERY", "What does a version such as {VERSION} represent in a CVE record?"),
        QueryTemplate("GENERAL_QUERY", "How are affected versions described in vulnerability records?"),
        QueryTemplate("GENERAL_QUERY", "What does it mean when a record like {CVE_ID} lists affected software?"),
        QueryTemplate("GENERAL_QUERY", "How can a CVE such as {CVE_ID} be used during analysis?"),
        QueryTemplate("GENERAL_QUERY", "Why do analysts compare {METRIC} with {SEVERITY} severity?"),
        QueryTemplate("GENERAL_QUERY", "What is the difference between a CVE ID and a CVSS metric?"),
        QueryTemplate("GENERAL_QUERY", "How does the NVD connect CVE IDs, products, and versions?"),
        QueryTemplate("GENERAL_QUERY", "Why are severity labels useful when prioritizing vulnerabilities?"),
        QueryTemplate("GENERAL_QUERY", "What does vulnerability triage mean?"),
        QueryTemplate("GENERAL_QUERY", "How do analysts decide which vulnerabilities to review first?"),
        QueryTemplate("GENERAL_QUERY", "What does exploitability mean in vulnerability analysis?"),
    ),
}
