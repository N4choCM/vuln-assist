...
class EntitySampler:
    ...
    def extract_placeholder_values(self, placeholders: tuple[str, ...]) -> dict[str, str]:
        ...
        for placeholder in placeholders:
            if placeholder == "CVE_ID":
                ...
                values[placeholder] = self._extract_product_placeholder(record)
            elif placeholder == "VERSION":
                values[placeholder] = self._extract_version_placeholder(record)
            elif placeholder == "SEVERITY":
                values[placeholder] = self._extract_severity_placeholder(record)
    ...
    def to_entity_values(self, values: dict[str, str]) -> list[EntityValue]:
    ...
    def _extract_product_placeholder(self, record: NormalizedCVE) -> str:
    ...
    def _extract_version_placeholder(self, record: NormalizedCVE) -> str:
    ...
    def _extract_severity_placeholder(self, record: NormalizedCVE) -> str:
